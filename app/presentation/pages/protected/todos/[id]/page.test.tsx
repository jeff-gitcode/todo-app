...
jest.mock('@/app/presentation/components/todo-item', () => jest.fn(() => <div>TodoItem Component</div>));
...
describe('EditTodoPage', () => {
    ...
    it('renders loading state', () => {
        ...
        (useTodoById as jest.Mock).mockReturnValue({ data: null, isLoading: true, isError: false });
    ...
    it('renders error state', () => {
        (usePathname as jest.Mock).mockReturnValue('/protected/todos/1');
        (useTodoById as jest.Mock).mockReturnValue({ data: null, isLoading: false, isError: true });
    ...
    it('renders TodoItem component with todo data', () => {
        ...
        (usePathname as jest.Mock).mockReturnValue('/protected/todos/1');
        (useTodoById as jest.Mock).mockReturnValue({ data: mockTodo, isLoading: false, isError: false });
